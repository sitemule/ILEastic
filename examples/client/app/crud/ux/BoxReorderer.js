 ...
 */
Ext.define('Mvvm.crud.ux.BoxReorderer', {
    requires: [
        'Ext.dd.DD'
    ],
    ...
    endDrag: function(e) {
        ...
        if (me.dragCmp && !me.reorderer.removeOnDrop(e.target.offsetParent, me.dragCmp)) {
            delete me.dragElId;
    ...
    // THIS IS FOR HANDLING DROP IF WE SHOULD REMOVE THEM
    removeOnDrop: function() {
        return false;
    },
