...
dcl-proc main;
    ...
    il_addPlugin (config : %paddr(security)   : IL_PREREQUEST );
...
// -----------------------------------------------------------------------------
// It is a servlet - bu called before any other servlet
// from here you can call any other servlet you like 
// and if you want to brek the normal flow sinply return *OFF
// -----------------------------------------------------------------------------     
dcl-proc security;
    ...
    return okToRun; // I have handled the request
