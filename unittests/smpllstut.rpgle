**free
//   CRTRPGMOD MODULE(&LI/&OB) SRCFILE(&SL/&SF) +
//     SRCMBR(&SM) OPTION(*EVENTF) DBGVIEW(*LIST) TRUNCNBR(*NO)
//
//   CRTSRVPGM SRVPGM(&LI/&OB) MODULE(&LI/&OB &LI/SIMPLELIST &LI/VARCHAR &LI/STRUTIL) +
//     BNDSRVPGM(*LIBL/RUTESTCASE) ACTGRP(*CALLER) DETAIL(*BASIC) EXPORT(*ALL) +
//     INCDIR('/usr/local/include/irpgunit')
